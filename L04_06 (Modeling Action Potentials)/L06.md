...
$$ I*{\rm Na} = g*{\rm Na} m^3 h(V-E\_{\rm Na}). $$
...
$$ I*{\rm Na} = g*{\rm Na} m^3 hj(V-E\_{\rm Na}). $$
...
$$ \bar{I}_{x} = P_{x}z*{x}^2V\frac{F^{2}}{RT}\frac{\gamma*{xi}[X_i]e^{\frac{z*{x}VF}{RT}}-\gamma*{xo}[X_{o}]}{e^{{\frac{z_{x}VF}{RT}}}-1}$$
