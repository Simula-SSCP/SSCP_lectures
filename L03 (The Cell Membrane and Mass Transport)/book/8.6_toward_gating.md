...
For now, we will use what we have learned so far to make a very simpel model of the action potential in {doc}`Exercise 8.4: A super simple action potential model <8.7_exercise_simple_ap_model>`.
