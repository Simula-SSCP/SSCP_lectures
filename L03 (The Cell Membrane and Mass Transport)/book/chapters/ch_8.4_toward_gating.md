...
For now, we will use what we have learned so far to make a very simple model of the action potential in {doc}`Exercise 8.3: A super simple action potential model <../exercises/exercise_8.3_simple_ap_model>`.
